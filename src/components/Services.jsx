...
const servicesData = [
  {
    ...
    description: 'I build scalable, high-performance server-side applications using Java and Spring Boot. From RESTful API design and database architecture to deployment, I deliver secure, production-ready backend systems.',
    capabilities: [
      'Build robust REST APIs with Spring Boot & Spring MVC',
      'Implement authentication & authorization with Spring Security, JWT & OAuth2',
      'Design scalable microservices architecture',
      'Develop event-driven systems with Apache Kafka',
  ...
  },
  {
    ...
    description: 'I design and optimize database schemas and data access layers using both relational and NoSQL databases, ensuring data integrity, performance, and scalability.',
    capabilities: [
      'PostgreSQL',
      'MongoDB',
      'MySQL',
  ...
  },
  {
    ...
    description: 'I architect well-structured APIs and distributed systems following industry best practices, focusing on reliability, scalability, and clean separation of concerns.',
    capabilities: [
      'RESTful API Design',
  ...
  },
  {
    ...
    description: 'I integrate AI capabilities into backend systems using LLM APIs and RAG pipelines to build intelligent applications with semantic search and automated code review.',
    capabilities: [
  ...
  },
  {
    ...
    description: 'I implement caching strategies and message-driven architectures to improve application performance, resilience, and real-time processing capabilities.',
    capabilities: [
  ...
  },
  {
    id: '06',
    title: 'DEVOPS & TOOLS',
    description: 'I streamline development workflows with containerization, CI/CD pipelines, and modern tooling to ensure reliable, automated, and efficient software delivery.',
    capabilities: [
