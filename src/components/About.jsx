...
const frontendSkills = ["Java", "Python", "SQL", "C", "YAML", "JSON", "XML"];
const backendSkills = ["Spring Boot", "Spring MVC", "Spring Security", "Spring Data JPA", "Spring Kafka", "Hibernate"];
const aiSkills = ["RESTful APIs", "Microservices", "Event-Driven Architecture", "Apache Kafka", "Redis", "JWT", "OAuth2", "Webhooks", "System Design"];
const toolsSkills = ["Docker", "Docker Compose", "GitHub Actions", "Git", "Maven", "Swagger/OpenAPI", "Linux", "Postman", "PostgreSQL", "MongoDB", "MySQL", "Flyway"];

const aboutWords = [
  { text: "Hey," }, { text: "I'm" },
  { text: "Rachit.", className: "font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400" },
  { text: "A" }, { text: "final-year" }, { text: "Computer" }, { text: "Science" }, { text: "student" }, { text: "seeking" }, { text: "a" }, { text: "Backend" }, { text: "Developer" }, { text: "Internship." },
  { text: "I" }, { text: "have" }, { text: "hands-on" }, { text: "experience" }, { text: "building" }, { text: "server-side" }, { text: "applications" }, { text: "and" }, { text: "REST" }, { text: "APIs" }, { text: "using" },
  ...
  { text: "with" }, { text: "working" }, { text: "proficiency" }, { text: "in" },
  { text: "Python", className: "text-white font-medium" },
  { text: "and" },
  { text: "SQL.", className: "text-white font-medium" },
  { text: "I" }, { text: "have" }, { text: "a" }, { text: "strong" }, { text: "foundation" }, { text: "in" }, { text: "OOP," }, { text: "data" }, { text: "structures," }, { text: "algorithms," }, { text: "and" }, { text: "system" }, { text: "design" }, { text: "—" }, { text: "quick" }, { text: "to" }, { text: "pick" }, { text: "up" }, { text: "new" }, { text: "backend" }, { text: "stacks" }, { text: "and" }, { text: "frameworks." }
];
